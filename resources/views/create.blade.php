    ...
    <div class="container-fluid bg-3 w-50 p-3"> 
        ...
        <form action="{{ route('contacts.store') }}" method="POST">
            ...
            <div class="row bg-dark text-white m-1 p-3">
                ...
                <div class="col-sm-4"><strong>Email</strong></div><div class="col-sm-8 mb-2"><input type="email" name="email" class="form-control form-control-lg" ></div>
                <div class="col-sm-4"><strong>Phone Number</strong></div><div class="col-sm-8 mb-2"><input type="number" name="phone" class="form-control form-control-lg" ></div>
